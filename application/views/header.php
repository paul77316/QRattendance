...
<head>
    ...
    <link href="<?= base_url('assets/fonts_googleapis/font-googleapis.css')?>" rel="stylesheet">
   ...
   <!--  <link href="<?= base_url('assets/jquery-ui/jquery-ui.css')?> " rel="stylesheet"> -->
      <!-- DataTable CSS-->
      <!-- <link href="<?= base_url('assets/data_tables/dataTables.bootstrap.min.css')?> " rel="stylesheet"> -->
...
<!--    <script src="<?=  base_url('assets/data_tables/dataTables.bootstrap.min.js');?> "></script>
    <script src="<?=  base_url('assets/data_tables/jquery.dataTables.min.js');?> "></script> -->
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <h6 class="collapse-header">Bulk Upload:</h6>
                        <a class="collapse-item" href="<?= base_url('main/upload_student');?>">Import Students</a>
                    </div>
                </div>
            </li>
